...
public class PostDaoImpl_post_jdbc implements PostDao {
	
	private JdbcTemplate jdbcTemplate;
	
	public PostDaoImpl_post_jdbc(JdbcTemplate jdbcTemplate) {
...
//		PostData postData = null;
	...
	public int getPostNumByStreetNameANDHouseNum(PostData postData) {
		...
		return getPostNumByStreetNameANDHouseNum(postData.getStreetName(), postData.getHouseNum());
	}
}
